    ...
    <div v-if="addOrUpdateIsShow">
      ...
      <div id="print">
        <el-table :data="tableData" border v-loading="loading">
          <el-table-column prop="holidayTypeCode" header-align="center" align="center" label="类型编码"></el-table-column>
          <el-table-column prop="holidayTypeName" header-align="center" align="center" label="类型名称"></el-table-column>
          <el-table-column
            prop="holidayTypeSimName"
            header-align="center"
            align="center"
            label="类型简称"
          ></el-table-column>
          ...
          <el-table-column label="操作" fixed="right" align="center" width="100">
            <template slot-scope="scope">
              <el-button type="text" size="small" @click="addNew(scope.row.holidayTypeCode)">编辑</el-button>
