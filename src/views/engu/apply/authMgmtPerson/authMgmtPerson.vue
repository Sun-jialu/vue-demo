  ...
  <div class="authMgmtPerson">
    ...
    <div v-if="addOrUpdateIsShow">
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="证件类型:">
              <el-select v-model="dataForm.certTypeId" clearable placeholder="请选择">
                <el-option
                  :label="item.name"
                  :value="item.value"
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="权限:">
              <el-select v-model="dataForm.authName" clearable placeholder="请选择">
                <el-option
                  :label="item.name"
                  :value="item.value"
                  v-for="(item,index) in authNameArr"
                  :key="index"
                ></el-option>
              </el-select>
            </el-form-item>
      ...
      <el-table :data="tableData" border v-loading="listLoading">
        ...
        <el-table-column align="center" header-align="center" prop="deptId" label="部门"></el-table-column>
        <el-table-column align="center" header-align="center" prop="authNameauthName" label="权限名称"></el-table-column>
...
<script>
import addOrUpdate from "./personAddUp";
