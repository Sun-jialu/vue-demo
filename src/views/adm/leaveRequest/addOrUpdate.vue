<template>
  <div class="leaveRequestAdd">
    <titleBar title="请假/出差申请"></titleBar>
    <el-form
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="请假/出差类型：" prop="leaveType">
            <el-select v-model="addOrUpdateForm.leaveType" clearable placeholder="请选择请假/出差类型">
              <el-option
                :label="item.name"
                :value="item.value"
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="开始时间：" prop="leaveBeginTimes">
            <el-date-picker
              v-model="addOrUpdateForm.leaveBeginTimes"
              type="datetime"
              placeholder="选择开始时间"
        ...
        <el-col :span="8">
          <el-form-item label="结束时间：" prop="leaveEndTimes">
            <el-date-picker
              v-model="addOrUpdateForm.leaveEndTimes"
              type="datetime"
              placeholder="选择结束时间"
              format="yyyy-MM-dd HH:mm:ss"
              value-format="yyyy-MM-dd HH:mm:ss"
        ...
        <el-col :span="8">
          <el-form-item label="请假/出差原因：" prop="leaveReason">
            <el-input
              type="textarea"
              rows="1"
              v-model="addOrUpdateForm.leaveReason"
              maxlength="200"
            ></el-input>
          </el-form-item>
        </el-col>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        leaveReason: [
          { required: true, message: "请假/出差原因不能为空", trigger: "blur" },
        ],
      },
    };
  },
