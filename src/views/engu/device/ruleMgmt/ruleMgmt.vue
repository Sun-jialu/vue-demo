    ...
    <div v-if="addOrUpdateIsShow">
      ...
      <div id="print">
        <el-table :data="tableData" border v-loading="loading">
          ...
          <el-table-column prop="verNo" header-align="center" align="center" label="版本号"></el-table-column>
          <el-table-column prop="verTerrace" header-align="center" align="center" label="版本平台"></el-table-column>
