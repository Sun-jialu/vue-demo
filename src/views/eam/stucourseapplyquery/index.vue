        ...
        <div id="print">
            ...
            label="操作" fixed="right" align="center" width="120">
                <template slot-scope="scope">
                    <el-button type="text" size="small" @click="addNew(scope.row.studentApplyId,scope.row.schoolId)">修改</el-button>
...
import { getPageListByParam,deleteData,deleteDataAll} from "@/api/eam/stucourseapplyquery";
...
export default {
  ...
  methods: {
    ...
    deleteColumn(id,schoolId){
        ...
        var studentApplyIdsArr=[]
         for(let i in this.multipleSelection){
             studentApplyIdsArr.push(this.multipleSelection[i].studentApplyId)
         }
         console.log(studentApplyIdsArr)
         if(studentApplyIdsArr.length==0){
             return false
         }else{
            ...
            type: 'warning'
                ...
                if(id){
                    ...
                    params={
                        ...
                        "studentApplyIds":studentApplyIdsArr
                    }
                }
