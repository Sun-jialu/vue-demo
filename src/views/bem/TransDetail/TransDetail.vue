<template>
  <div class="TransDetail">
    ...
    <div class="TransDetail1">
      ...
      >
        <el-table-column prop="oppositeAccount" align="center" label="对方账号"></el-table-column>
        <el-table-column prop="oppositeAccountName" align="center" label="对方账户名称"></el-table-column>
        <el-table-column prop="oppositeAccountName" align="center" label="交易时间"></el-table-column>
        <el-table-column prop="debitAmount" align="center" label="借方发生额(元)"></el-table-column>
        <el-table-column prop="creditAmount" align="center" label="贷方发生额(元)"></el-table-column>
        <el-table-column prop="accountBalance" align="center" label="余额(元)"></el-table-column>
