<template>
  <div class="authMgmtStat">
    <!-- 首部标题 -->
    <titleBar></titleBar>
    <div class="authMgmtStat1">
      <!-- 顶部form表单 -->
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="证件类型:">
              <el-select v-model="dataForm.certTypeId" placeholder="请选择" clearable>
                <el-option
                  :label="item.name"
                  :value="item.value"
      ...
      >
        ...
        <el-table-column prop="certNo" header-align="center" align="center" label="累计识别次数"></el-table-column>
        <el-table-column prop="groupId" header-align="center" align="center" label="首次识别时间"></el-table-column>
        <el-table-column prop="identDate" header-align="center" align="center" label="末次识别时间"></el-table-column>
      </el-table>
      <!-- 分页 -->
      <el-pagination
