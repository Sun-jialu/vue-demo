<template>
  <div class="PayMoneyDetail">
    <!-- 首部标题 -->
    <titleBar></titleBar>
    <div class="PayMoneyDetail1">
      <!-- 顶部form表单 -->
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="机构分组:">
              <el-select v-model="dataForm.orgTeam" placeholder="请选择">
                <!-- <el-option
          ...
          <el-col :span="8">
            <el-form-item label="清算批次号:">
              <el-input v-model="dataForm.planNum"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <!-- 课程名称，学员姓名,学员号-->
      ...
      >
        <el-table-column prop="subAccount" header-align="center" align="center" label="付款账号"></el-table-column>
        <el-table-column prop="subAccountName" header-align="center" align="center" label="付款账户名称"></el-table-column>
        <el-table-column prop="operType" header-align="center" align="center" label="收款账号"></el-table-column>
        <el-table-column prop="bese" header-align="center" align="center" label="收款账户名称"></el-table-column>
        <el-table-column prop="useTime" header-align="center" align="center" label="拨付金额"></el-table-column>
        <el-table-column prop="username" header-align="center" align="center" label="拨付时间"></el-table-column>
        <el-table-column prop="subAccount" header-align="center" align="center" label="操作员"></el-table-column>
        <el-table-column prop="subAccountName" header-align="center" align="center" label="付款用途"></el-table-column>
        <el-table-column prop="operType" header-align="center" align="center" label="备注"></el-table-column>
        <el-table-column prop="bese" header-align="center" align="center" label="机构分组"></el-table-column>
        <el-table-column prop="useTime" header-align="center" align="center" label="机构名称"></el-table-column>
      </el-table>
      <!-- 分页 -->
      <el-pagination
