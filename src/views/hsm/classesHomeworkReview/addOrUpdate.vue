      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="作业内容：" prop="content">
            <tinymce :maxHeight="400" v-model="addForm.content" disabled></tinymce>
          </el-form-item>
        </el-col>
      </el-row>
      <b>作业提交信息</b>
          ...
          <el-row>
            <el-col>
              <el-form-item label="提交内容:">
                <el-input type="textarea" v-model="addForm.commitContent" rows="6" :disabled="true"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </el-col>
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="批阅内容:" prop="reviewContent">
            <el-input maxlength="200" show-word-limit v-model="addForm.reviewContent" placeholder="请输入字符在200字以内"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <!-- 提交,取消 -->
  ...
  methods: {
    ...
    async change() {
      let res = await updateData({
        reviewContent: this.addForm.reviewContent,
        id: this.addForm.id
      });
      if (res && res.rsCode == "AAAAAAA") {
        let data = res.data;
