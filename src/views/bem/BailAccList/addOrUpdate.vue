<template>
  <div>
    <!-- 头部标题 -->
    <titleBar :title="!addForm.id ? '设置保证金账户' : '修改保证金账户'"></titleBar>
    <el-form
      :model="addForm"
      :rules="rules"
      ref="addForm"
    ...
    >
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="保证金账号:" prop="account">
            <el-input v-model="addForm.account"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="保证金账户名称:" prop="accountName">
  ...
  data() {
    return {
      ...
      rules: {
        //保证金账号
        account: [
          { required: true, message: "保证金账号不能为空", trigger: "blur" }
        ],
        //所属银行
        bankId: [
        ...
        //保证金账户名称
        accountName: [
          { required: true, message: "保证金账户名称不能为空", trigger: "blur" }
        ],
        //省
        proviceId: [
