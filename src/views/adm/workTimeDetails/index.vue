    ...
    <div v-if="addOrUpdateIsShow">
      ...
      <div id="print">
        <el-table :data="tableData" border v-loading="loading">
          ...
          <el-table-column prop="leaveTime" header-align="center" align="center" label="下班时间"></el-table-column>
          ...
          <el-table-column prop="leaveReason" header-align="center" align="center" label="处理信息"></el-table-column>
          <!-- <el-table-column
