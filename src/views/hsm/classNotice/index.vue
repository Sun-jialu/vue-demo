<template>
  <div class="classNotice">
    <!-- 首部标题 -->
    <titleBar></titleBar>
    <div class="classNotice1" v-if="show">
      <!-- 顶部form表单 -->
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="状态:">
              <el-select v-model="dataForm.delState" placeholder="状态">
      ...
      >
        ...
        <el-table-column prop="title" header-align="center" align="center" label="通知标题"></el-table-column>
        <el-table-column prop="updateUserName" header-align="center" align="center" label="发布人"></el-table-column>
        <el-table-column prop="updateTime" header-align="center" align="center" label="最后更新日期"></el-table-column>
        <el-table-column prop="startDate" header-align="center" align="center" label="生效日期"></el-table-column>
        <el-table-column prop="endDate" header-align="center" align="center" label="失效日期"></el-table-column>
        <el-table-column prop="delStateValue" header-align="center" align="center" label="状态"></el-table-column>
        ...
        >
          <template slot-scope="scope">
            ...
            <el-button type="text" size="small" @click="issue(scope.row)">发布</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页 -->
...
import { getPageListByParam, releaseOrDelData } from "@/api/hsm/classNotice";
...
export default {
  ...
  methods: {
    ...
    async issue(list) {
      ...
      let res = await releaseOrDelData({
        delState: 1,
        id: list.id
      });
      if (res && res.rsCode == "AAAAAAA") {
