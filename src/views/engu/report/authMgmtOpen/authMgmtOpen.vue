<template>
  <div class="authMgmtOpen">
    <!-- 首部标题 -->
    <titleBar></titleBar>
    <div class="authMgmtOpen1">
      <!-- 顶部form表单 -->
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="开门类型:">
              <el-select v-model="dataForm.openAccessType" placeholder="请选择" clearable>
                <el-option
                  :label="item.name"
                  :value="item.value"
                  v-for="(item,index) in openAccessTypeArr"
                  :key="index"
                ></el-option>
              </el-select>
            </el-form-item>
      ...
      >
        ...
        <el-table-column prop="deptId" header-align="center" align="center" label="部门"></el-table-column>
        <el-table-column prop="openTime" header-align="center" align="center" label="开门时间"></el-table-column>
        <el-table-column prop="openAccessType" header-align="center" align="center" label="开门类型"></el-table-column>
