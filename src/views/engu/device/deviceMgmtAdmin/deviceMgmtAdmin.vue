  ...
  <div class="deviceMgmtDevice">
    ...
    <div v-if="addOrUpdateIsShow">
      ...
      <el-table :data="tableData" border v-loading="listLoading">
        ...
        <el-table-column align="center" header-align="center" prop="deviceId" label="设备号"></el-table-column>
        ...
        <el-table-column align="center" header-align="center" prop="deviceNumber" label="设备序列号"></el-table-column>
        <el-table-column align="center" header-align="center" prop="state" label="通讯状态"></el-table-column>
        <el-table-column align="center" header-align="center" prop="commumode" label="进出方向"></el-table-column>
