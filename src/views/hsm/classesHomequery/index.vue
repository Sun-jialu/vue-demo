<template>
  <div class="classesHomequery">
    <!-- 首部标题 -->
    <titleBar></titleBar>
    <div class="classesHomequery1" v-if="show">
      <!-- 顶部form表单 -->
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="批阅状态:">
              <el-select v-model="dataForm.reviewState" placeholder="请选择">
      ...
      >
        ...
        <el-table-column prop="reviewStateValue" header-align="center" align="center" label="批阅状态"></el-table-column>
