<template>
  <div class="BatchBankBalance">
    <!-- 首部标题 -->
    <titleBar></titleBar>
    <div class="BatchBankBalance1">
      <!-- 顶部form表单 -->
      <el-form
        :model="dataForm"
      ...
      >
        ...
        <el-table-column prop="availableBalance" align="center" label="可用余额(元)"></el-table-column>
        <el-table-column prop="accountBalance" align="center" label="账户余额(元)"></el-table-column>
