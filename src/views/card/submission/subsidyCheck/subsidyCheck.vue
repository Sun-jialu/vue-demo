            ...
            <el-row>
                ...
                <el-col :span="8">
                    <el-form-item label="申请批次号：" label-width="120px">
                        <el-input v-model="sizeForm.batch" placeholder="请输入"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="核对结果：" label-width="120px">
                        <el-select v-model="sizeForm.result" placeholder="请选择">
                             <el-option label="全部" value></el-option>
                            <el-option label="区域一" value="shanghai"></el-option>
                            <el-option label="区域二" value="beijing"></el-option>
                        </el-select>
          ...
          <el-form ref="form1" :model="sizeForm">
            <el-row>
                <el-col :span="12">
                    <div >
                        <el-form-item>
                            <el-button plain type="primary" @click="Okdeon">确定</el-button>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
    ...
    export default {
      ...
      components:{
       ...
       methods: {
        ...
        // 查询
        inquire(){
        console.log("subsidyCheck查询");
        },
        // 打印预览
        print() {
        console.log("subsidyCheck打印预览");
        },
        // 导出excel
        expor() {
        console.log("subsidyCheck导出excel");
        },
        // 查看
