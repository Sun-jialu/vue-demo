      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="作业标题:" prop="title">
            <el-input maxlength="20" show-word-limit v-model="addForm.title" placeholder="请输入的字符在20字以内"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <!-- 通知内容 -->
...
import { getDataById, addData, updateData } from "@/api/hsm/classesHomework";
  ...
  data() {
    return {
      ...
      rules: {
        //作业标题
        title: [
          { required: true, message: "作业标题不能为空", trigger: "change" },
          {
            min: 0,
            max: 20,
            message: "长度在20 个字符以内",
