<template>
  <div class="classCircle">
    <!-- 首部标题 -->
    <titleBar></titleBar>
    <div class="classCircle1" v-if="show">
      <!-- 顶部form表单 -->
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label-width="0px">
              <el-button plain type="primary" @click="removeAll()">删除</el-button>
              <el-button plain type="primary" @click="removePic()">仅删图片</el-button>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
      ...
      >
        ...
        <el-table-column prop="summary" header-align="center" align="center" label="班级动态摘要"></el-table-column>
        <el-table-column prop="filePath" header-align="center" align="center" label="图片">
          <template v-slot="scope">
            <img class="addListImg" :src="scope.row.filePath" alt />
          </template>
        </el-table-column>
        ...
        <el-table-column prop="leaveMsgNum" header-align="center" align="center" label="留言人数"></el-table-column>
        <el-table-column prop="likeNum" header-align="center" align="center" label="点赞人数"></el-table-column>
