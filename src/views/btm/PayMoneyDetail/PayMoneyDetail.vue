<template>
  <div class="PayMoneyDetail">
    ...
    <div class="PayMoneyDetail1">
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="清算批次号:">
              <el-input v-model="dataForm.clearBatchNo"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <!-- 课程名称，学员姓名,学员号-->
        <el-row>
          <el-col :span="8">
            <el-form-item label="课程名称:">
              <el-input v-model="dataForm.currName"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="学员姓名:">
              <el-input v-model="dataForm.stuName"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="学员号:">
              <el-input v-model="dataForm.stuNo"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <!--开始日期 结束日期  查询-->
      ...
      >
        <el-table-column prop="payTime" header-align="center" align="center" label="收费日期"></el-table-column>
        <el-table-column prop="payTime" header-align="center" align="center" label="待拨付总额"></el-table-column>
        <el-table-column prop="bailAmt" header-align="center" align="center" label="保证金"></el-table-column>
        <el-table-column prop="amt" header-align="center" align="center" label="课程费用"></el-table-column>
        <el-table-column prop="currName" header-align="center" align="center" label="课程名称"></el-table-column>
        <el-table-column prop="stuName" header-align="center" align="center" label="学员姓名"></el-table-column>
        <el-table-column prop="stuName" header-align="center" align="center" label="学员号"></el-table-column>
        ...
        <el-table-column prop="clearTime" header-align="center" align="center" label="清算批次号"></el-table-column>
        <el-table-column prop="orgGroupName" header-align="center" align="center" label="机构分组"></el-table-column>
        <el-table-column prop="orgGroupName" header-align="center" align="center" label="机构"></el-table-column>
      </el-table>
      <!-- 分页 -->
      <el-pagination
