<template>
  <div class="eamClassAdd">
    <titleBar :title="!id ? '新增' : '批阅'"></titleBar>
      ...
      this.id =  id || 0
       this.$nextTick(() => {
        ...
        if(this.id){
          ...
          getDataById({"studentWorkanswerId":this.id,"schoolId":this.addOrUpdateForm.schoolId}).then(res => {
              console.log("res",res)
        ...
        let arrid=[]
         if(this.id){
          ...
          let obj={
                ...
                "schoolId":this.addOrUpdateForm.schoolId
          }
